...
def init_rag(force_reload=False):
    docs = load_files()
...
# PDF -> Chunk -> Embedding -> Milvus (Vector DB)
# Question -> Embedding -> Milvus (Vector DB) -> Chunks of Result-> Query + Context -> Language Model -> Answer

# Clinical Embedding Model

# Question -> Embedding -> Milvus (Vector DB) -> Chunks of Result -> 
# Chunk -> NER -> Entity -> Query Clinical Model -> Embedding -> Average Embedding -> Rerank -> Answer
