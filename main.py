...
import os
from langchain.document_loaders import PyPDFLoader  # Updated import for single PDF loading
...
parser.add_argument("--pdf-file", type=str, required=True, help="Path to the PDF file")  
...
if __name__ == "__main__":
    pdf_file_path = args.pdf_file  # Get the PDF file path from arguments
    docs = load_pdf(pdf_file_path)  # Load the specified PDF file
    demo = ui()
