...
parser.add_argument('--temp', type=float, default=0.2, help='Temperature for text generation')  # Lower temperature for more factual responses
...
def is_generic_greeting(message):
    ...
    # Check if it's a very short message (1-2 words) and matches closely
...
def predict(message, history):
    ...
    results = rag_search(mc, encoder, dict_list, message, top_k=5)  # Increased from 2 to 5
